#
#  Be sure to run `pod spec lint easy_layout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "future-challenger" => "sunshine_anycall@hotmail.com" }
  # Or just: s.author    = "future-challenger"
  # s.authors            = { "future-challenger" => "sunshine_anycall@hotmail.com" }
  # s.social_media_url   = "http://twitter.com/future-challenger"
  ...
  s.source       = { :git => "https://github.com/future-challenger/easy_layout.git", :tag => "0.0.2" }
